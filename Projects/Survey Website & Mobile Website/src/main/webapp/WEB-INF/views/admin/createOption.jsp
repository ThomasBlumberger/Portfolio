...
<html xmlns:th="http://www.thymeleaf.org">
	...
	<section class="createUser_box">
			...
			<form:form modelAttribute="option" class="createAccForm" method="post" action="/admin/addOption?question=${questionID}">
				<form:label path="questionOption">Option for question:</form:label><br/>
				<form:input path="questionOption" required="required" placeholder="Enter a option for the question"></form:input>
