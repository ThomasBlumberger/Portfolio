...
<html lang="en">
	...
	<body>
		...
		<section class="content">
			...
			<c:forEach items="${convenors}" var="convenor">
			<div class="objdiv-inline">
				<h3>Name: ${convenor.name}&nbsp;&nbsp;&nbsp;Username: ${convenor.username}</h3>
			  		<div class="buts">

			  			<a class="sec_but" href="/admin/removeConvenor?username=${convenor.username}">Remove</a>
					</div>
			  	</div>
			</c:forEach>
		</section>
